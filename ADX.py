...
try:
	...
	os.system('https://chat.whatsapp.com/Lje6yDaKThu7OEQrfMTbps?mode=gi_t')
	##-------------(Basic colors)-------------------
yellow = "\033[1;33m"
black = "\033[1;90m"
red = "\033[1;91m"
...
pink = "\x1b[38;5;205m"
brown = "\x1b[38;5;208m"
colors = ("\033[0;30m", "\033[1;30m", "\033[0;31m", "\033[1;31m", "\033[0;32m", "\033[1;32m",
...
def WEHSHI________():
    clear()
    print(f"\033[1;90m[\033[1;97m1\033[1;90m]\033[0;97m OLD 2009 & 2010 CLONING")
    print(f"\033[1;90m[\033[1;97m2\033[1;90m]\033[0;97m OLD 2011 to 2014 CLONING")
    ...
    if option == "1":
        ...
        print(f"{red}[!] Invalid choice! Exiting..."); exit()
